<?php
	...
	class Key extends REST_Controller {
		protected $methods = array(
			'index_post'      => array( 'level' => 10, 'limit' => 10 ),
		...
		public function regenerate_post () {
			...
			// Insert the new key
			if ( $this->_insert_key( $new_key, array( 'level'         => $key_details->level,
		...
		private function _get_clientId ( $username, $password ) {
			$query = $this->rest->db->where( 'username', $username )->get( config_item( 'rest_client_table' ) )->row();
